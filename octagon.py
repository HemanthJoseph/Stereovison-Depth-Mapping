...
def main():
    ...
    img_0 = cv.imread("octagon/im0.png") #reading image 0
    resized_img_0 = rescaleFrame(img_0)
    gray_0 = cv.cvtColor(resized_img_0, cv.COLOR_BGR2GRAY)

    img_1 = cv.imread("octagon/im1.png") #reading image 1
    ...
    orb = cv.ORB_create(nfeatures = 300) #by default it takes 500 as max no. of features
    ...
    cv.imwrite("octagon_image_outputs/keypoints_0.jpg", imgmatches_1)
    cv.waitKey(0)
    ...
    cv.imwrite("octagon_image_outputs/keypoints_1.jpg", imgmatches_2)
    cv.waitKey(0)
    ...
    Fundamental_matrix = np.round(Fundamental_matrix)
    ...
    cv.imwrite("octagon_image_outputs/epilines_0.jpg", img5)
    cv.waitKey(0)
    cv.imshow("epilines 1", img3)
    cv.imwrite("octagon_image_outputs/epilines_1.jpg", img3)
    cv.waitKey(0)
    ...
    cv.imwrite("octagon_image_outputs/rectified_0.jpg", img_0_rectified)
    cv.waitKey(0)
    cv.imshow("img1 rectified", img_1_rectified)
    cv.imwrite("octagon_image_outputs/rectified_1.jpg", img_1_rectified)
    cv.waitKey(0)
    ...
    plt.savefig('octagon_image_outputs/depth_image.png')
    plt.show()
